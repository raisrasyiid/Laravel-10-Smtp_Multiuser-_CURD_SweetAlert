	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="{{route('registrasi')}}" method="POST" enctype="multipart/form-data">
                    @csrf
					...
					<div style="margin: 20px 20px 40px 20px;">
						<label for="gambar" class="mb-10" style="font-size: 16pt; color:#666666">Gambar</label>
					...
					<div class="text-center p-t-46 p-b-20">
						<span class="txt2">
							<a href="{{route('auth')}}" class="text-primary">Already Account?</a>
						</span>
					</div>
